...
def construct_prompt(row, trim=False):
    prompt = "Generate 75 useful commonsense cooking questions and answers with reasoning, for recipe " \
             "text below. Answers should be descriptive and have reasoning. Create answers when answers are not in the recipe text.\n "
    prompt += '\n"""\n\n'
